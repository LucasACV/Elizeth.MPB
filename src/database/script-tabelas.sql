...
sexo varchar(45),
fk_respostas int ,
constraint chk_resp foreign key (fk_respostas) references respostas (idrespostas)
);
...
fk_perguntas int,
constraint chk_perguntas foreign key (fk_perguntas) references perguntas (idperguntas)
);
